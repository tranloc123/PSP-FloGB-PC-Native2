...
if "inputP2:'CODEMASK_DYNAMIC_0x088F0BC8'" not in c:
    raise SystemExit('FIX12 P2 capability marker missing')
if "LEGACY_WORKFLOW_COMPAT_ONLY inputP2:'NOT_WIRED_GAME_INTERNAL_PATH'" not in c:
    raise SystemExit('FIX12 legacy workflow compatibility marker missing')
